...
| Embeddings | OpenAI `text-embedding-3-small` (default) or Gemini `gemini-embedding-001`, server-wide switch, not per-request | See `docs/adr/0006-embedding-and-vector-search.md` (OpenAI decision) and `docs/adr/0009-swappable-embedding-provider.md` (provider switch) |
